...
-- Volcando datos para la tabla gameon.areas_deportivas: ~15 rows (aproximadamente)
INSERT INTO `areas_deportivas` (`id`, `institucion_deportiva_id`, `deporte_id`, `nombre_area`, `descripcion`, `capacidad_jugadores`, `tarifa_por_hora`, `estado`, `imagen_area`, `creado_en`) VALUES
	...
	(37, 5, 1, 'prueba5', 'prueba5', 22, 50.00, 'activa', NULL, '2025-06-26 15:36:20');
...
-- Volcando datos para la tabla gameon.areas_horarios: ~105 rows (aproximadamente)
INSERT INTO `areas_horarios` (`id`, `area_deportiva_id`, `dia`, `hora_apertura`, `hora_cierre`, `disponible`) VALUES
	...
	(113, 34, 'Lunes', '07:00:00', '21:00:00', 1),
	(114, 34, 'Martes', '07:00:00', '21:00:00', 1),
	(115, 34, 'Miercoles', '07:00:00', '21:00:00', 1),
	(116, 34, 'Jueves', '07:00:00', '21:00:00', 1),
	(117, 34, 'Viernes', '07:00:00', '21:00:00', 1),
	(118, 34, 'Sabado', '07:00:00', '21:00:00', 1),
	(119, 34, 'Domingo', '07:00:00', '21:00:00', 1),
	(120, 35, 'Lunes', '07:00:00', '21:00:00', 1),
	(121, 35, 'Martes', '07:00:00', '21:00:00', 1),
	(122, 35, 'Miercoles', '07:00:00', '21:00:00', 1),
	(123, 35, 'Jueves', '07:00:00', '21:00:00', 1),
	(124, 35, 'Viernes', '07:00:00', '21:00:00', 1),
	(125, 35, 'Sabado', '07:00:00', '21:00:00', 1),
	(126, 35, 'Domingo', '07:00:00', '21:00:00', 1),
	(127, 36, 'Lunes', '07:00:00', '21:00:00', 1),
	(128, 36, 'Martes', '07:00:00', '21:00:00', 1),
	(129, 36, 'Miercoles', '07:00:00', '21:00:00', 1),
	(130, 36, 'Jueves', '07:00:00', '21:00:00', 1),
	(131, 36, 'Viernes', '07:00:00', '21:00:00', 1),
	(132, 36, 'Sabado', '07:00:00', '21:00:00', 1),
	(133, 36, 'Domingo', '07:00:00', '21:00:00', 1);
...
-- Volcando datos para la tabla gameon.reservas: ~8 rows (aproximadamente)
...
INSERT INTO `torneos` (`id`, `nombre`, `descripcion`, `deporte_id`, `organizador_tipo`, `organizador_id`, `institucion_sede_id`, `max_equipos`, `equipos_inscritos`, `fecha_inicio`, `fecha_fin`, `fecha_inscripcion_inicio`, `fecha_inscripcion_fin`, `estado`, `modalidad`, `premio_1`, `premio_2`, `premio_3`, `costo_inscripcion`, `imagen_torneo`, `creado_en`, `actualizado_en`) VALUES
	(7, 'CHAMPIONS LEAGUE TACNA - APERTURA I', 'La mejor edición Champions Tacna, ven, juega y gana y demuestra tus habilidades con tu equipo!', 1, 'institucion', 1, 1, 4, 1, '2025-07-20', '2025-07-20', '2025-06-30', '2025-07-10', 'inscripciones_cerradas', 'eliminacion_simple', 'Un arroz con Huevo', 'Un huevo sin arroz', 'Un arroz sin huevo', 1.00, 'https://i.ibb.co/BHQxk6nj/3d686d3b1636.jpg', '2025-06-19 03:00:18', '2025-06-26 18:08:38'),
	(9, 'Copa Prueba 1', 'prueba', 1, 'institucion', 1, 1, 4, 0, '2025-07-26', '2025-07-28', '2025-06-26', '2025-07-10', 'inscripciones_abiertas', 'eliminacion_simple', 'Medalla Oro para el equipo + FIFA25', 'Medalla Plata para el equipo + 100 soles', 'Medalla Bronce para el equipo + un abrazo', 10.00, NULL, '2025-06-26 20:17:54', '2025-06-26 20:18:54'),
	(10, 'Copa Prueba 2', 'prueba2', 1, 'institucion', 1, 1, 10, 1, '2025-07-31', '2025-08-02', '2025-06-28', '2025-07-23', 'inscripciones_abiertas', 'eliminacion_simple', 'Medalla Oro para el equipo + FIFA25', 'Medalla Plata para el equipo + 100 soles', 'Medalla Bronce para el equipo + un abrazo', 0.00, NULL, '2025-06-26 20:22:38', '2025-06-26 20:43:05');
...
INSERT INTO `torneos_equipos` (`id`, `torneo_id`, `equipo_id`, `inscrito_por_usuario_id`, `fecha_inscripcion`, `estado_inscripcion`, `metodo_pago`, `transaction_id`, `payer_id`, `monto_pagado`, `comentarios`) VALUES
	...
	(4, 10, 1, 2, '2025-06-26 20:43:05', 'confirmada', 'gratuito', NULL, NULL, 0.00, NULL);
...
-- Volcando datos para la tabla gameon.torneos_partidos: ~17 rows (aproximadamente)
INSERT INTO `torneos_partidos` (`id`, `torneo_id`, `area_deportiva_id`, `equipo_local_id`, `equipo_visitante_id`, `fase`, `numero_partido`, `ronda`, `descripcion_partido`, `numero_grupo`, `fecha_partido`, `resultado_local`, `resultado_visitante`, `equipo_ganador_id`, `estado_partido`, `observaciones`, `creado_en`) VALUES
	...
	(26, 9, 16, NULL, NULL, 'primera_ronda', 1, 1, 'Primera Ronda - Partido 1', NULL, '2025-07-27 10:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:17:54'),
	(27, 9, 17, NULL, NULL, 'primera_ronda', 2, 1, 'Primera Ronda - Partido 2', NULL, '2025-07-27 11:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:17:54'),
	(28, 9, 16, NULL, NULL, 'final', 3, 2, 'Final - Partido 3', NULL, '2025-07-28 10:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:17:54'),
	(29, 10, 16, NULL, NULL, 'primera_ronda', 1, 1, 'Primera Ronda - Partido 1', NULL, '2025-07-31 06:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(30, 10, 17, NULL, NULL, 'primera_ronda', 2, 1, 'Primera Ronda - Partido 2', NULL, '2025-07-31 07:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(31, 10, 16, NULL, NULL, 'primera_ronda', 3, 1, 'Primera Ronda - Partido 3', NULL, '2025-07-31 07:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(32, 10, 17, NULL, NULL, 'primera_ronda', 4, 1, 'Primera Ronda - Partido 4', NULL, '2025-07-31 08:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(33, 10, 16, NULL, NULL, 'primera_ronda', 5, 1, 'Primera Ronda - Partido 5', NULL, '2025-07-31 08:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(34, 10, 16, NULL, NULL, 'segunda_ronda', 6, 2, 'Ronda 2 - Partido 6', NULL, '2025-08-01 08:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(35, 10, 17, NULL, NULL, 'segunda_ronda', 7, 2, 'Ronda 2 - Partido 7', NULL, '2025-08-01 09:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(36, 10, 16, NULL, NULL, 'tercera_ronda', 8, 3, 'Ronda 3 - Partido 8', NULL, '2025-08-02 09:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(37, 10, 16, NULL, NULL, 'final', 9, 4, 'Final - Partido 9', NULL, '2025-08-02 12:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(38, 10, 16, NULL, NULL, 'segunda_ronda', 0, 2, 'Ronda 2 - Pase Directo', NULL, '2025-08-02 14:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38'),
	(39, 10, 16, NULL, NULL, 'tercera_ronda', 0, 3, 'Ronda 3 - Pase Directo', NULL, '2025-08-02 22:00:00', NULL, NULL, NULL, 'programado', NULL, '2025-06-26 20:22:38');
